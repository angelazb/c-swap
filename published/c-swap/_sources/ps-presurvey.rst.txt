...
.. poll:: cs-CS-self-efficacy-3
    ...
    I am sure that I can learn programming in C.
...
.. poll:: cs-prog-se-vars-7
    ...
    Setting the value of a variable like: x = 'a' in C

.. poll:: cs-prog-se-swap-8
    :option_1: I am unfamiliar with this concept
    :option_2: I know what it means, but have not used it in a program
    :option_3: I have used this concept in a program, but am not confident about my ability to use it
    :option_4: I am confident in my ability to use this concept in a program
    ...
    Swapping the strings values of two variables so that var1 has the original string value of var2 and var2 has the original string value of var1

Feedback
==================================

.. shortanswer:: cs-presurvey-sa
